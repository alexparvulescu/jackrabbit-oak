...
public class MountPermissionProvider extends PermissionProviderImpl {
    ...
    @Override
    protected AbstractPermissionStore getPermissionStore(Root root, String workspaceName,
    ...
    private static class MountPermissionStore extends AbstractPermissionStore {
