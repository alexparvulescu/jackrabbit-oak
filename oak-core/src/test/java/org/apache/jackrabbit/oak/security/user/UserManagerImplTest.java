...
public class UserManagerImplTest extends AbstractSecurityTest {
    ...
    public void before() throws Exception {
        ...
        userMgr = new UserManagerImpl(root, namePathMapper, getSecurityProvider(), getNodeTypeManagementProvider(), getIdentifierManagementProvider());
            ...
            workers.add(new Thread(new Runnable() {
                public void run() {
                    try {
                        ...
                        UserManager userManager = new UserManagerImpl(root, namePathMapper, getSecurityProvider(), getNodeTypeManagementProvider(), getIdentifierManagementProvider());
